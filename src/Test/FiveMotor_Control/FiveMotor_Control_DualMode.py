...
if MY_DXL == 'X_SERIES' or MY_DXL == 'MX_SERIES':
    ...
    DXL_6_MINIMUM_POSITION_VALUE = 0        # Refer to the Minimum Position Limit of product eManual
    DXL_6_MAXIMUM_POSITION_VALUE  = 1800    # Refer to the Maximum Position Limit of product eManual
    DXL_7_MINIMUM_POSITION_VALUE = 0        # Refer to the Minimum Position Limit of product eManual
    DXL_7_MAXIMUM_POSITION_VALUE  = 1800    # Refer to the Maximum Position Limit of product eManual
...
dxl_6_goal_position = [DXL_6_MINIMUM_POSITION_VALUE, DXL_6_MAXIMUM_POSITION_VALUE]   # DXL_4_Goal position
dxl_7_goal_position = [DXL_7_MINIMUM_POSITION_VALUE, DXL_7_MAXIMUM_POSITION_VALUE]   # DXL_4_Goal position
...
while 1:
    ...
    param_goal_position4 = [DXL_LOBYTE(DXL_LOWORD(dxl_6_goal_position[index])), DXL_HIBYTE(DXL_LOWORD(dxl_6_goal_position[index])), DXL_LOBYTE(DXL_HIWORD(dxl_6_goal_position[index])), DXL_HIBYTE(DXL_HIWORD(dxl_6_goal_position[index]))]
    
    param_goal_position4 = [DXL_LOBYTE(DXL_LOWORD(dxl_7_goal_position[index])), DXL_HIBYTE(DXL_LOWORD(dxl_7_goal_position[index])), DXL_LOBYTE(DXL_HIWORD(dxl_7_goal_position[index])), DXL_HIBYTE(DXL_HIWORD(dxl_7_goal_position[index]))]
    ...
    dxl_addparam_result = groupSyncWrite.addParam(DXL6_ID, param_goal_position2)
    if dxl_addparam_result != True:
    ...
    dxl_addparam_result = groupSyncWrite.addParam(DXL7_ID, param_goal_position2)
    if dxl_addparam_result != True:
    ...
    while 1:
        ...
        # Check if groupsyncread data of Dynamixel#4 is available
        dxl_getdata_result = groupSyncRead.isAvailable(DXL7_ID, ADDR_PRESENT_POSITION, LEN_PRESENT_POSITION)
        if dxl_getdata_result != True:
        ...
        dxl7_present_position = groupSyncRead.getData(DXL7_ID, ADDR_PRESENT_POSITION, LEN_PRESENT_POSITION)


        print("[ID:%03d] GoalPos:%03d  PresPos:%03d\t[ID:%03d] GoalPos:%03d  PresPos:%03d\t[ID:%03d] GoalPos:%03d  PresPos:%03d\t[ID:%03d] GoalPos:%03d  PresPos:%03d\t[ID:%03d] GoalPos:%03d  PresPos:%03d" % (DXL1_ID, dxl_goal_position[index], dxl1_present_position, DXL2_ID, dxl_2_goal_position[index], dxl2_present_position, DXL4_ID, dxl_4_goal_position[index], dxl4_present_position, DXL6_ID, dxl_6_goal_position[index], dxl6_present_position, DXL7_ID, dxl_7_goal_position[index], dxl7_present_position))

        if not ((abs(dxl_goal_position[index] - dxl1_present_position) > DXL_MOVING_STATUS_THRESHOLD) or (abs(dxl_2_goal_position[index] - dxl2_present_position) > DXL_MOVING_STATUS_THRESHOLD) or (abs(dxl_4_goal_position[index] - dxl4_present_position) > DXL_MOVING_STATUS_THRESHOLD) or (abs(dxl_6_goal_position[index] - dxl6_present_position) > DXL_MOVING_STATUS_THRESHOLD) or (abs(dxl_7_goal_position[index] - dxl7_present_position) > DXL_MOVING_STATUS_THRESHOLD)):
            break
