...
#dxl_comm_result_1, dxl_error_1 = packetHandler.write1ByteTxRx(portHandler, DXL_ID, 11, 5)
#dxl_comm_result_2, dxl_error_2 = packetHandler.write2ByteTxRx(portHandler, DXL_ID, 102, 100)

#print(dxl_comm_result_1)
#print(dxl_comm_result_2)
...
while 1:
    ...
    if (MY_DXL == 'XL320'): # XL320 uses 2 byte Position Data, Check the size of data in your DYNAMIXEL's control table
        ...
        #dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, 1, 10, 1000)
    ...
    while 1:
        ...
        if (MY_DXL == 'XL320'): # XL320 uses 2 byte Position Data, Check the size of data in your DYNAMIXEL's control table
            ...
            print(f"portHandler : {portHandler}, DXL_ID : {DXL_ID}, ADDR_PRESENT_POSITION : {ADDR_PRESENT_POSITION}")
        if dxl_comm_result != COMM_SUCCESS:
            print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
        elif dxl_error != 0:
            print("%s" % packetHandler.getRxPacketError(dxl_error))
